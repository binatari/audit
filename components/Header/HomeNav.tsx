    ...
    <>
      <header className={`fixed top-0 left-0 w-full z-[100] nav-bg`}>
        ...
        <nav className="flex  justify-between  items-center container mx-auto py-8">
          <div className="max-h-[40px] h-10 flex-shrink-0 max-w-[140px]">
            <img src="/images/logo.svg" className="h-full" />
          </div>
      ...
      {openTab ? (
        <div className=" relative z-[1000] md:hidden">
          ...
          <nav className="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 linear-gradient  overflow-y-auto">
